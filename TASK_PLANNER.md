...
- [x] **Task W39-CAL04**: Automated Confirmation & RFC 5545 `.ics` Invite Dispatch: Automated calendar invite generation and notification dispatch upon booking confirmation. (Verified in `booking-link.service.ts` & `booking-engine.test.ts`).
- [x] **Task W39-CAL05**: Vitest Verification Suite (`booking-engine.test.ts` & `booking-page.test.tsx`): 100% green tests covering free/busy slots, conflict detection, lock TTL, and booking submission. (25/25 tests passing 100% green).
