  ...
  private registerDefaultModels(): void {
    const defaultModels: AIModelConfig[] = [
      // Cloudflare Workers AI models (serverless edge inference)
      {
        ...
        name: 'Llama 3.1 70B Instruct (Cloudflare Workers AI)',
        provider: 'cloudflare',
        capabilities: [
          'text_generation',
          'text_summarization',
      ...
      },
      {
        ...
        name: 'Llama 3.1 8B Instruct Fast (Cloudflare Workers AI)',
        provider: 'cloudflare',
        capabilities: [
          'text_generation',
          'text_summarization',
      ...
      },
      {
        ...
        name: 'Qwen 2.5 Coder 32B (Cloudflare Workers AI)',
        provider: 'cloudflare',
        capabilities: ['code_generation', 'text_generation', 'text_summarization'],
        maxContextLength: 32768,
        maxOutputTokens: 4096,
        costPerInputToken: 0.00000004,
      ...
      },
      {
        ...
        name: 'DeepSeek R1 Distill Qwen 32B (Cloudflare Workers AI)',
        provider: 'cloudflare',
        capabilities: [
          'text_generation',
          'text_summarization',
      ...
      },
      {
        ...
        name: 'Llama 3.2 3B Instruct (Cloudflare Workers AI)',
        provider: 'cloudflare',
        capabilities: ['text_generation', 'text_summarization', 'translation'],
        maxContextLength: 128000,
        maxOutputTokens: 4096,
      ...
      },
      {
        ...
        name: 'BGE Large EN v1.5 (Cloudflare Workers AI)',
        provider: 'cloudflare',
