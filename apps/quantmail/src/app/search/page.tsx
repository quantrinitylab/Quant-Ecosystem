            ...
            {FILTER_CHIPS.map((chip) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex min-h-11 sm:min-h-0 sm:h-8 shrink-0 items-center gap-1.5 rounded-full border px-3 text-xs font-medium whitespace-nowrap transition-colors ${
                    isActive
