...
export function CodeSnippetLibrary({ isOpen, onClose, onInsert }: CodeSnippetLibraryProps) {
  ...
  return (
    ...
    >
      ...
      <div className="snippet-search quant-filter-field">
        <input
          type="search"
        ...
        />
        {filter && <SearchClearButton onClear={() => setFilter('')} />}
      </div>
      {showAdd && (
