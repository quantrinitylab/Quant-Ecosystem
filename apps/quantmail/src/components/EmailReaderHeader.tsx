...
export function EmailReaderHeader({
  ...
  return (
    <div className="flex flex-col border-b border-zinc-800 bg-[#0c1017]/95 backdrop-blur-md sticky top-0 z-30">
      {/* Upper Navigation & Action Bar */}
      <div className="flex items-center justify-between px-3 sm:px-5 py-2.5">
        {/* Left Side: Back Button + Quanty Robo */}
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {/* Quanty AI Robo Button */}
          <button
            type="button"
            onClick={onOpenQuanty}
            className="group relative flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-purple-500/10 border border-cyan-500/30 hover:border-cyan-400 hover:shadow-[0_0_15px_rgba(6,182,212,0.25)] transition-all cursor-pointer select-none"
            title="Ask Quanty AI"
          >
            ...
            <span className="text-xs font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent hidden sm:inline">
              Quanty
            </span>
          </button>
        </div>

        {/* Right Side: Archive, Delete, Star, 3-Dots */}
        <div className="flex items-center gap-1 sm:gap-1.5">
          ...
          <div className="relative" ref={menuRef}>
            ...
            {isMenuOpen && (
              <div className="absolute right-0 mt-2 w-60 rounded-2xl border border-zinc-800 bg-[#161a24]/98 backdrop-blur-xl shadow-2xl p-1.5 z-50 text-xs text-zinc-200">
      ...
      {/* Subheader: User Profile Photo & Email ID (No duplicate subject box) */}
      <div className="px-4 sm:px-6 py-2.5 flex items-center justify-between gap-3 bg-zinc-950/40 border-t border-zinc-800/40">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {localImportant && (
            <span className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-rose-500/15 border border-rose-500/30 text-[10px] font-bold text-rose-400">
          ...
          <span className="px-2.5 py-0.5 rounded-full bg-blue-600/20 border border-blue-500/30 text-[10px] font-semibold text-blue-400 shrink-0">
            {category}
          </span>
        </div>
      </div>
