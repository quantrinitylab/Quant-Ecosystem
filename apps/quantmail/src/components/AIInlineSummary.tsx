...
function generateLocalSummary(subject: string, snippet: string): string | null {
  ...
  if (combined.includes('invitation') || combined.includes('invite'))
  ...
  if (combined.includes('shipped') || combined.includes('tracking') || combined.includes('delivered'))
