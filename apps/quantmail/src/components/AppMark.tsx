 ...
 *
 * Exported because the graphite twin in `marks/GraphiteMark.tsx` is the same
 * silhouette in a different material, and a 900-character path copied into a
 * second file is a path that will drift.
 */
