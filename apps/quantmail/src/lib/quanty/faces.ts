...
export const FACES = {
  ...
  // ============================================================================
  // 🫧 THE 35 CANONICAL BUBBLE INTELLIGENCE ANIMATIONS (media_1789322423559.jpg)
  // ============================================================================
  wake_up: { eyes: 'wide', lid: 0.95, mouth: 'smile', accent: 'ember', label: 'wake up' },
  look_around: { eyes: 'capsule', gaze: [3, 0], extras: ['spark'], label: 'looking around' },
  recognize_you: {
    eyes: 'arch',
    mouth: 'smile',
    extras: ['blush'],
    accent: 'ember',
    label: 'recognizing you',
  },
  thinking_deep: {
    eyes: 'bar',
    eyeH: 0.42,
  ...
  reading: { eyes: 'bar', eyeH: 0.4, gaze: [-3, 2], blinkFloor: 0.85, label: 'reading' },
  analyzing: { eyes: 'bar', eyeH: 0.38, gaze: [3, 1], extras: ['dots'], label: 'analyzing' },
  coding: { eyes: 'capsule', mouth: 'flat', extras: ['spark'], accent: 'ember', label: 'coding' },
  refactoring: {
    eyes: 'bar',
    eyeH: 0.45,
    mouth: 'smile',
  ...
  debugging: { eyes: 'wide', eyeW: 1.1, eyeH: 0.95, gaze: [2, 2], label: 'debugging' },
  fixing: { eyes: 'arch', mouth: 'smile', extras: ['spark'], accent: 'ember', label: 'fixing' },
  explaining: { eyes: 'capsule', mouth: 'smile', extras: ['spark'], label: 'explaining' },
  planning: { eyes: 'capsule', gaze: [2, -3], mouth: 'flat', label: 'planning' },
  organizing: { eyes: 'bar', eyeH: 0.42, mouth: 'smile', label: 'organizing' },
  creating: { eyes: 'star', mouth: 'smile', extras: ['spark'], accent: 'gold', label: 'creating' },
  improving: {
    eyes: 'arch',
    mouth: 'grin',
    extras: ['spark'],
  ...
  multiple_options: { eyes: 'wide', gaze: [-3, 0], mouth: 'o', label: 'multiple options' },
  almost_done: {
    eyes: 'arch',
    lid: 0.85,
    mouth: 'smile',
  ...
  thinking_again: {
    ...
    extras: ['dots'],
    accent: 'ember',
    label: 'thinking again',
  },
  need_more_info: { eyes: ['capsule', 'wide'], extras: ['question'], label: 'need more info' },
  typing: { eyes: 'capsule', gaze: [0, 3], extras: ['dots'], label: 'typing' },
  searching: { eyes: 'wide', gaze: [3, -2], extras: ['dots'], label: 'searching' },
  syncing: { eyes: 'capsule', extras: ['pulse'], accent: 'ember', label: 'syncing' },
  saving: { eyes: 'bar', eyeH: 0.42, mouth: 'smile', accent: 'ember', label: 'saving' },
  celebration: {
    eyes: 'star',
    mouth: 'grin',
    extras: ['confetti', 'spark'],
