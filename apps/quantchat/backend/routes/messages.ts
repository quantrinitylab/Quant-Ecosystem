...
const sendMessageSchema = z.object({
  ...
  // The snap composer sends `disappearMode: 'after_view'`. Zod strips unknown keys, so
  // while this was absent the ephemeral intent was silently discarded and every snap was
  // stored as a plain image. Must stay in sync with `DisappearMode` in src/types/index.ts.
