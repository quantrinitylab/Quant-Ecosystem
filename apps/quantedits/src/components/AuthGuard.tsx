// ============================================================================
// QuantCooks — login gate.
// An unauthenticated visitor is sent to /login instead of a permanently-loading
...
export function AuthGuard({ children }: { children: React.ReactNode }) {
  ...
  if (!isAuthenticated)
    return <AuthPending state="redirecting" loginPath="/login" appName="QuantEdits" />;
  return <>{children}</>;
}
